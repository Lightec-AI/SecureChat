...
If the feature is related to the Secure AI as developed by Lightec, please submit a request in the [Feature Requests & Suggestions category](https://github.com/Lightec-AI/SecureChat/discussions/new?category=feature-requests-suggestions) or create an issue in [issues](https://github.com/Lightec-AI/SecureChat/issues). If not, please follow the LibreChat processes as detailed below.
